  ...
  return (
    <div className="bg-white min-h-screen py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-blue">
            <h1 className="text-4xl font-bold text-deepBlue mb-4">Privacy Policy</h1>
            <p className="text-gray-500 mb-8">Last updated: February 2025</p>
            
            <div className="space-y-8 text-gray-700 leading-relaxed">
                <section>
                    <h2 className="text-xl font-bold text-deepBlue mb-3">1. Information We Collect</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-bold text-deepBlue mb-3">2. How We Use Your Information</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-bold text-deepBlue mb-3">3. Sharing of Information</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-bold text-deepBlue mb-3">4. Security</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-bold text-deepBlue mb-3">5. Your Choices</h2>
                    <p>
