  ...
  <div className="bg-offWhite min-h-screen py-12">
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-16">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-deepBlue mb-4">How Unfindable Works</h1>
        <p className="text-base sm:text-lg md:text-xl text-gray-600">The reverse marketplace that puts demand first.</p>
      </div>
      ...
      <div className="space-y-24">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12">
            ...
            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-deepBlue mb-4">Post Your Request</h2>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center">
          <div className="md:w-1/2 mb-8 md:mb-0 md:pl-12">
            ...
            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-deepBlue mb-4">Finders Get to Work</h2>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12">
            ...
            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-deepBlue mb-4">Accept & Receive</h2>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
