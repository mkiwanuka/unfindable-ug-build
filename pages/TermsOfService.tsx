  ...
  return (
    <div className="bg-white min-h-screen py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-blue">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-deepBlue mb-4">Terms of Service</h1>
            <p className="text-gray-500 mb-8">Last updated: February 2025</p>
            
            <div className="space-y-8 text-gray-700 leading-relaxed">
                <section>
                    <h2 className="text-lg sm:text-xl font-bold text-deepBlue mb-3">1. Acceptance of Terms</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-lg sm:text-xl font-bold text-deepBlue mb-3">2. The Marketplace Model</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-lg sm:text-xl font-bold text-deepBlue mb-3">3. User Accounts</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-lg sm:text-xl font-bold text-deepBlue mb-3">4. Fees and Payments</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-lg sm:text-xl font-bold text-deepBlue mb-3">5. Prohibited Items & Conduct</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-lg sm:text-xl font-bold text-deepBlue mb-3">6. Dispute Resolution</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-lg sm:text-xl font-bold text-deepBlue mb-3">7. Termination</h2>
                    <p>
