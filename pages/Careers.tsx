  ...
  return (
    <div className="min-h-screen bg-offWhite py-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 text-center">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-deepBlue mb-6">Join Our Team</h1>
      ...
      <div className="bg-white py-16 border-y border-gray-200 mb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-center text-deepBlue mb-12">Why Unfindable?</h2>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-deepBlue mb-8">Open Positions</h2>
          ...
          {openings.map((job, idx) => (
            <div key={idx} className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:border-softTeal hover:shadow-md transition-all cursor-pointer group flex flex-col md:flex-row md:items-center justify-between">
              <div className="mb-4 md:mb-0">
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 group-hover:text-softTeal transition-colors">{job.title}</h3>
