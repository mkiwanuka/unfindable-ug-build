    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="bg-deepBlue text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6">About Unfindable</h1>
      ...
      <div className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
           <div className="p-6">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-deepBlue mb-2">Reverse Marketplace</h3>
           ...
           <div className="p-6">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-deepBlue mb-2">Global Network</h3>
           ...
           <div className="p-6">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-deepBlue mb-2">Secure & Trusted</h3>
      ...
      <div className="bg-offWhite py-16">
         <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-deepBlue mb-6">Our Story</h2>
