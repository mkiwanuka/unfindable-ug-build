    ...
    <div className="min-h-screen bg-offWhite py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-deepBlue mb-4">Newsroom</h1>
            ...
            <div key={idx} className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              <div className="flex flex-col md:flex-row md:items-center justify-between">
                <div className="mb-4 md:mb-0">
                  ...
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-2 hover:text-deepBlue">
        ...
        <div className="bg-deepBlue rounded-2xl p-12 text-center text-white">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">Media Resources</h2>
        ...
        <div className="mt-16 text-center">
          <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">Press Inquiries</h3>
          <p className="text-gray-600">
